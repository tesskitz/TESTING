...
diary('m_xyz2uint16_cat.txt') 
catr=xyz2uint16(catx)
diary off  
diary('m_xyz2uint16_j.txt') 
lenajr=xyz2uint16(lenajx)
diary off  
diary('m_xyz2uint16_b.txt') 
lenabr=xyz2uint16(lenabx)
diary off  
diary('m_xyz2uint16_t.txt') 
lenatr=xyz2uint16(lenatx)
diary off  
diary('m_xyz2uint16_rect.txt') 
rectr=xyz2uint16(rectx)
diary off  
