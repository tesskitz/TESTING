...
diary('m_lab2rgb_cat.txt') 
catr=lab2rgb(catl)
diary off  
diary('m_lab2rgb_j.txt') 
lenajr=lab2rgb(lenajl)
diary off  
diary('m_lab2rgb_b.txt') 
lenabr=lab2rgb(lenabl)
diary off  
diary('m_lab2rgb_t.txt') 
lenatr=lab2rgb(lenatl)
diary off  
diary('m_lab2rgb_rect.txt') 
rectr=lab2rgb(rectl)
diary off  
