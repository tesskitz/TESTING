...
diary('m_imdivide-constant_cat.txt') 
catdc=imdivide(cat,2)
diary off  
diary('m_imdivide-constant_j.txt') 
lenajdc=imdivide(lenaj,2)
diary off  
diary('m_imdivide-constant_b.txt') 
lenabdc=imdivide(lenab,2)
diary off  
diary('m_imdivide-constant_t.txt') 
lenatdc=imdivide(lenat(:,:,(1:3)),2)
diary off  
diary('m_imdivide-constant_rect.txt') 
rectdc=imdivide(rect,2)
diary off
  
diary('m_imdivide-image_cat.txt') 
catdi=imdivide(cat,cat1)
diary off  
diary('m_imdivide-image_j.txt') 
lenajdi=imdivide(lenaj,lenaj1)
diary off  
diary('m_imdivide-image_b.txt') 
lenabdi=imdivide(lenab,lenab1)
diary off  
diary('m_imdivide-image_t.txt') 
lenatdi=imdivide(lenat(:,:,(1:3)),lenat1(:,:,(1:3)))
diary off  
diary('m_imdivide-image_rect.txt') 
rectdi=imdivide(rect,rect1)
diary off  
...
subplot(4,2,1)
imshow(catdc)
title('Cat divided by constsnt');
subplot(4,2,2)
imshow(lenajdc)
title('Lena-j divided by constsnt');


subplot(4,2,3)
imshow(lenabdc)
title('Lena-b divided by constsnt');
 
subplot(4,2,4)
imshow(lenatdc(:,:,(1:3)))
title('Lena-t divided by constsnt');


subplot(4,2,5)
imshow(rectdc)
title('Rect divided by constsnt');
