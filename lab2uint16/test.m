...
diary('m_lab2uint16_cat.txt') 
catr=lab2uint16(catl)
diary off  
diary('m_lab2uint16_j.txt') 
lenajr=lab2uint16(lenajl)
diary off  
diary('m_lab2uint16_b.txt') 
lenabr=lab2uint16(lenabl)
diary off  
diary('m_lab2uint16_t.txt') 
lenatr=lab2uint16(lenatl)
diary off  
diary('m_lab2uint16_rect.txt') 
rectr=lab2uint16(rectl)
diary off  
