...
diary('m_rgb2lab_cat.txt') 
catlab=rgb2lab(cat)
diary off  
diary('m_rgb2lab_j.txt') 
lenalabj=rgb2lab(lenaj)
diary off  
diary('m_rgb2lab_b.txt') 
lenalabb=rgb2lab(lenab)
diary off  
diary('m_rgb2lab_t.txt') 
lenalabt=rgb2lab(lenat(:,:,(1:3)))
diary off  
diary('m_rgb2lab_rect.txt') 
rectlab=rgb2lab(rect)
diary off  
