...
diary('m_xyz2double_cat.txt') 
catr=xyz2double(catx)
diary off  
diary('m_xyz2double_j.txt') 
lenajr=xyz2double(lenajx)
diary off  
diary('m_xyz2double_b.txt') 
lenabr=xyz2double(lenabx)
diary off  
diary('m_xyz2double_t.txt') 
lenatr=xyz2double(lenatx)
diary off  
diary('m_xyz2double_rect.txt') 
rectr=xyz2double(rectx)
diary off  
