...
diary('m_lab2uint8_cat.txt') 
catr=lab2uint8(catl)
diary off  
diary('m_lab2uint8_j.txt') 
lenajr=lab2uint8(lenajl)
diary off  
diary('m_lab2uint8_b.txt') 
lenabr=lab2uint8(lenabl)
diary off  
diary('m_lab2uint8_t.txt') 
lenatr=lab2uint8(lenatl)
diary off  
diary('m_lab2uint8_rect.txt') 
rectr=lab2uint8(rectl)
diary off  
