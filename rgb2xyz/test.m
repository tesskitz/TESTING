...
diary('m_rgb2xyz_cat.txt') 
catxyz=rgb2xyz(cat)
diary off  
diary('m_rgb2xyz_j.txt') 
lenaxyzj=rgb2xyz(lenaj)
diary off  
diary('m_rgb2xyz_b.txt') 
lenaxyzb=rgb2xyz(lenab)
diary off  
diary('m_rgb2xyz_t.txt') 
lenaxyzt=rgb2xyz(lenat(:,:,(1:3)))
diary off  
diary('m_rgb2xyz_rect.txt') 
rectxyz=rgb2xyz(rect)
diary off  
