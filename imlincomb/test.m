...
diary('m_imlincomb-image_cat.txt') 
catdi=imlincomb(1,cat,-1,cat1)
diary off  
diary('m_imlincomb-image_j.txt') 
lenajdi=imlincomb(1,lenaj,-1,lenaj1)
diary off  
diary('m_imlincomb-image_b.txt') 
lenabdi=imlincomb(1,lenab,-1,lenab1)
diary off  
diary('m_imlincomb-image_t.txt') 
lenatdi=imlincomb(1,lenat(:,:,(1:3)),-1,lenat1(:,:,(1:3)))
diary off  
diary('m_imlincomb-image_rect.txt') 
rectdi=imlincomb(1,rect,-1,rect1)
diary off  
