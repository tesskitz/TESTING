...
diary('m_impyramid-expansion_cat.txt') 
catdi=impyramid(cat,'expand')
diary off
diary('m_impyramid-reduction_cat.txt') 
catdir=impyramid(cat,'reduce')
diary off  
diary('m_impyramid-expansion_j.txt') 
lenajdi=impyramid(lenaj,'expand')
diary off
diary('m_impyramid-reduction_j.txt') 
lenajdir=impyramid(lenaj,'reduce')
diary off   
diary('m_impyramid-expansion_b.txt') 
lenabdi=impyramid(lenab,'expand')
diary off 
diary('m_impyramid-reduction_b.txt') 
lenabdir=impyramid(lenab,'reduce')
diary off  
diary('m_impyramid-expansion_t.txt') 
lenatdi=impyramid(lenat(:,:,(1:3)),'expand')
diary off 
diary('m_impyramid-reduction_t.txt') 
lenatdir=impyramid(lenat(:,:,(1:3)),'reduce')
diary off  
diary('m_impyramid-expansion_rect.txt') 
rectdi=impyramid(rect,'expand')
diary off  
diary('m_impyramid-reduction_rect.txt') 
rectdir=impyramid(rect,'reduce')
diary off  
